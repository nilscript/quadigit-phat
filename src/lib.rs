    ...
    I2C: Write<Error = E> + WriteRead<Error = E>,
{
    ...
    /// assert_eq!(phat.display_buffer()[6..8], [DisplayData::from_byte(0b1100_0000), DisplayData::from_byte(0b0011_1111)]);
    ///
    ...
    {
        let offset = Digit::into_enum_iter().skip(offset as usize).flatten();
